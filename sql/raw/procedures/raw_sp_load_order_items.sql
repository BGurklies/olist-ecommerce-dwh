...
BEGIN
    ...
    BEGIN
        ...
        VALUES (
            @batch_id,     @job_run_id, @pipeline_id,         'raw.sp_load_order_items',
            @error_msg,    SYSUTCDATETIME(), ISNULL(@file_name, 'UNKNOWN'), 16, 'raw.sp_load_order_items', NULL
        );
    ...
    VALUES (
        @batch_id,      @job_run_id, @pipeline_id,
        'RAW',          'raw.sp_load_order_items', 'raw.order_items',
    ...
    BEGIN TRY
        ...
        INSERT INTO raw.order_items (
            ...
            freight_value, load_ts,    file_name
        )
        SELECT
            @batch_id,   order_id,     order_item_id,  product_id,
            seller_id,   shipping_limit_date,          price,
            freight_value, SYSUTCDATETIME(), @file_name
        ...
        WHERE batch_id = @batch_id AND sp_name = 'raw.sp_load_order_items';
