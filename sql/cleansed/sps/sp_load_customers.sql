...
BEGIN
    ...
    -- --------------------------------------------------------
    -- 1. Error Logging (DQ Checks) - based on raw.customers
    -- --------------------------------------------------------
    ...
    ON tgt.customer_id = src2.customer_id
    WHEN MATCHED AND tgt.row_hash <> src2.row_hash THEN
        UPDATE SET
            customer_unique_id = src2.customer_unique_id,
            customer_zip_code_prefix = src2.customer_zip_code_prefix,
            customer_city = src2.customer_city,
            customer_state = src2.customer_state,
            row_hash = src2.row_hash,
            updated_at = GETDATE()
    WHEN NOT MATCHED BY TARGET THEN
        ...
        VALUES (
            src2.customer_id,
            src2.customer_unique_id,
            src2.customer_zip_code_prefix,
            src2.customer_city,
            src2.customer_state,
            src2.row_hash,
            GETDATE()
